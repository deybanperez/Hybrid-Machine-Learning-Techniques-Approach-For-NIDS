...
hidden.neurons = readRDS("source/parameter_selection/NN/GFR/tuned_model_19_features.rds")
...
saveRDS(list.results, file = "source/tuned_model/GFR/NN/testing_set/list_results_19_features.rds")