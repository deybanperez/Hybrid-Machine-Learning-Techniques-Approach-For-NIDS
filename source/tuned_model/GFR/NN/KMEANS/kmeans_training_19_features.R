...
saveRDS(object = jambu.results, file = "source/tuned_model/GFR/NN/KMEANS/jambu_results_19_features.rds")
...
saveRDS(object = measures.results, file = "source/tuned_model/GFR/NN/KMEANS/measures_results_19_features.rds")