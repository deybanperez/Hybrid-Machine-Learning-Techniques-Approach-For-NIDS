...
testing.set.kmeans = testing.set[, svm.gfr]
testing.set.kmeans = cbind(testing.set.kmeans, Label = Label)
...
diff.attacks = readRDS(file = "source/final_model/testing_set/diff_attacks.rds")
...
kmeans.set = testing.set.kmeans[predictions == "normal", ]
