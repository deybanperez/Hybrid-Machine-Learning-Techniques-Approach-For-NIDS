...
```
Y calculamos la tasa de aciertos por etiqueta:
```{r}
AccuracyPerLabel(attack.normal.confusion.matrix.five, dataset.two)
```
En el paso anterior utilizamos el conjutno de datos **dataset.two** debido a que este conjunto de datos es el que posee las etiquetas binarias **Attack** o **normal**.
