...
confusion.matrix
```
Se puede notar un rendimiento excelente en la clasificación de cada una de las clases salvo en **U2R** donde no fue capaz de acertar de manera correcta en ningún caso. Ahora calculemos la tasa de aciertos para el mejor modelo.
