...
saveRDS(object = jambu.results, file = "source/default_parameters/PCA/KMEANS/jambu_results_24_features.rds")
...
saveRDS(object = measures.results, file = "source/default_parameters/PCA/KMEANS/measures_results_24_features.rds")