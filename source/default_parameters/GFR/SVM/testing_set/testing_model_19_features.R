...
results = readRDS("source/default_parameters/GFR/SVM/testing_set/list_results_19_features.rds")
...
generate_ROC(roc.data$Prob, roc.data$Label, roc.data$Prediction, tittle = '(6) GFR - SVM - K-Medias')
