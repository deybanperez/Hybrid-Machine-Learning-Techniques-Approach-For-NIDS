...
Por último en vista para preparar el ambiente de trabajo para las siguientes actividades, se unificará el nuevo espacio de variables predictoras con las etiquetas correspondientes a cada registro.
...
Lo siguiente será el cálculo de la *desviación estándar* y la *media* respectivamente.
